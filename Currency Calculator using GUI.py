...
def currency_converter():
 ...
 currency_converter.title("URVANSH PYTHON PROJECT")
 ...
 size = tuple(int(_) for _ in currency_converter.geometry().split('+')[0].s
plit('x'))
 x = w/2 - size[0]/2
 y = h/2 - size[1]/2
 ...
 Headline_Label = Label(currency_converter, text='Currency Converter', bg='
#007780', fg='white',font=("Century Gothic",16))
 Headline_Label.grid(row=0,column=0, columnspan=2, padx=5, pady=5, sticky=W
)
 Box_Headline_Label = Label(currency_converter, text='Which Currency?', bg=
'#007780', fg='white',font=("Century Gothic",11))
 Box_Headline_Label.grid(row=1,column=0, columnspan=1, padx=5, pady=5, stic
ky=W)
 box_value = StringVar()
 ...
 Currency_Output_Label = Label(currency_converter, text='', bg='#007780', f
g='white',font=("Century Gothic",11))
 Currency_Output_Label.grid(row=2,column=1, padx=5, pady=5, sticky=W)
 Currency_Output1_Label = Label(currency_converter, text='', bg='#007780',
fg='white',font=("Century Gothic",11))
 Currency_Output1_Label.grid(row=3,column=1, padx=5, pady=5, sticky=W) 
 Currency_Output2_Label = Label(currency_converter, text='', bg='#007780',
fg='white',font=("Century Gothic",11))
 ...
 Button(currency_converter,text="Quit",command=close_currency_converter).gr
id(row=6,column=0, sticky=E+S+W, pady=5, padx=5)
